...
# 전처리기
import numpy as np                                      # 넘파이 자료형 (배열간의 연산)
from tensorflow.keras.models import Sequential          # 모델 Sequential 클래스 사용
from tensorflow.keras.layers import Dense               # 층 Dense 클래스 사용
from sklearn.model_selection import train_test_split    # train_test_split 클래스 사용
