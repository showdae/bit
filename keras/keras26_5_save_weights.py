...
model.save_weights('./_save/keras26_5_save_weight1.h5')     # save_weight1 !!!
...
# save model
# model.save('./_save/keras26_3_save_model.h5')   # h5: 확장자, 모델의 구조만 저장되어 있음 (가중치는 저장되지 않음)
                                                # 해당 위치에서 저장할 경우 가중치까지 저장됨 !!!
                                                
model.save_weights('./_save/keras26_5_save_weight2.h5')     # # save_weight2 !!!
