# 모델 파일 compile, fit 후에 로드

from sklearn.datasets import load_boston
from sklearn.model_selection import train_test_split
from tensorflow.python.keras.models import Sequential, Model, load_model    # save = model.save, model = load_model !!!
...
#2. 모델
model = load_model('./_save/keras26_3_save_model.h5')   # 해당 path의 모델 로드
                                                        # 가중치까지 저장된 모델 로드하기 때문에 !!!
                                                        # 항상 loss 값이 동일함 !!! [loss:  79.82951]
